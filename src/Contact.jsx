...
const quickActions = [
  ...
  { icon: '💬', label: 'WhatsApp', sublabel: 'Chat with us', action: 'https://wa.me/919876543210', color: '#25D366' },
...
export default function Contact() {
  ...
  return (
    <main className="contact-page" id="contact-page">
      ...
      {/* WhatsApp FAB */}
      <a href="https://wa.me/919876543210" className="whatsapp-fab" target="_blank" rel="noopener noreferrer">
